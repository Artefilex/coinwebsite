...
const Features = () => {
  ...
  return (
    <div className='gbt3__features section__padding' id='features'>
        <div className='gbt3__features-heading'>
            <h1 className='gradient__text'>THe Feature is Now and You Just Need To Realize It. Step into Futre Today & Make it Happen</h1>
